...
import com.wdit.traffic_flutter.sdk.QueryParams;
...
import com.wdit.traffic_flutter.sdk.tools.ActivityHelper;
import com.wdit.traffic_flutter.sdk.tools.CurrencyFormatter;
...
public class TrackHelper {
    private static final String TAG = Traffic.tag(TrackHelper.class);
    ...
    static abstract class BaseEvent {
        ...
        public void with(TrafficApplication trafficApplication) {
            with(trafficApplication.getTracker());
        }
        ...
        public boolean safelyWith(TrafficApplication trafficApplication) {
            return safelyWith(trafficApplication.getTracker());
        }
     ...
     *
     * @param path Example: "/rmsh_icon_wd_unchecked/settings/billing"
    ...
    public static class Screen extends BaseEvent {
         ...
         *
         * @see com.wdit.traffic.sdk.extra.CustomDimension and {@link #dimension(int, String)}
         * @deprecated Consider using <a href="http://traffic.org/docs/custom-dimensions/">Custom Dimensions</a>
         */
        @Deprecated
        ...
        /**
         * The marketing campaign for this visit if the rmsh_icon_wd_unchecked opens the app for example because of an
    ...
    /**
     * Events are a useful way to collect data about a rmsh_icon_wd_unchecked's interaction with interactive components of your app,
     ...
     *                 You might define event categories based on the class of rmsh_icon_wd_unchecked actions,
     ...
     *                 In the example, we are basically saying that the category of the event is rmsh_icon_wd_unchecked clicks,
    ...
    public static class EventBuilder extends BaseEvent {
         ...
         * Example: "/rmsh_icon_wd_unchecked/settings/billing", if you pass NULL, the last path set by #trackScreenView will be used.
         */
    ...
    /**
     * By default, Goals in Traffic are defined as "matching" parts of the screen path or screen title.
     ...
     * when a rmsh_icon_wd_unchecked submits a form
     * when a rmsh_icon_wd_unchecked has stayed more than a given amount of time on the page
     * when a rmsh_icon_wd_unchecked does some interaction in your Android application
     *
     * @param idGoal id of goal as defined in traffic goal settings
     */
    ...
    /**
     * Tracks an  <a href="http://traffic.org/faq/new-to-traffic/faq_71/">Outlink</a>
     *
    ...
    /**
     * Tracks an  <a href="http://traffic.org/docs/site-search/">site search</a>
     *
     ...
     * Case {@link com.wdit.traffic.sdk.extra.DownloadTracker.Extra.ApkChecksum}:<br>
     * http://packageName:versionCode/apk-md5-checksum<br>
     * <p>
     * Case {@link com.wdit.traffic.sdk.extra.DownloadTracker.Extra.None}:<br>
    ...
    public static class Download {
         ...
         *
         * @param identifier {@link com.wdit.traffic.sdk.extra.DownloadTracker.Extra.ApkChecksum} or {@link com.wdit.traffic.sdk.extra.DownloadTracker.Extra.None}
         * @return this object, to chain calls.
         */
    ...
    /**
     * Tracks a shopping cart. Call this javascript function every time a rmsh_icon_wd_unchecked is adding, updating
     ...
     * Keep in mind Traffic is not a crash tracker, use this sparingly.
     * <p>
     ...
     * This would mean the same exception (event) is tracked as different events by Traffic.
     *
     ...
     * <p>
     * See discussion here: https://github.com/traffic-org/traffic-sdk-android/issues/28
     */
    ...
    public static class UncaughtExceptions {
        ...
        public Thread.UncaughtExceptionHandler with(Tracker tracker) {
            if (Thread.getDefaultUncaughtExceptionHandler() instanceof TrafficExceptionHandler) {
                throw new RuntimeException("Trying to wrap an existing TrafficExceptionHandler.");
            }
            Thread.UncaughtExceptionHandler handler = new TrafficExceptionHandler(tracker, mBaseBuilder.mBaseTrackMe);
