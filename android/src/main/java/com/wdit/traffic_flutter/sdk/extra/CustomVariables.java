 ...
 * <p>
 * You can track up to 5 custom variables for each rmsh_icon_wd_unchecked to your app,
 * and up to 5 custom variables for each screen view.
 * You may configure Traffic to track more custom variables: http://traffic.org/faq/how-to/faq_17931/
 * <p>
 * Desired json output:
 * {
 * "1":["OS","iphone 5.0"],
 * "2":["Traffic Mobile Version","1.6.2"],
 * "3":["Locale","en::en"],
 * "4":["Num Accounts","2"],
 * "5":["Level","over9k"]
 * }
...
public class CustomVariables {
    ...
    private static final String TAG = Traffic.tag(CustomVariables.class);
     ...
     *              You may configure Traffic to track more custom variables than 5.
     *              Read more: http://traffic.org/faq/how-to/faq_17931/
    ...
    public CustomVariables put(int index, String name, String value) {
        if (index > 0 && name != null & value != null) {
            ...
            //Timber.tag(TAG).w("Index is out of range or name/value is null");
        }
        return this;
    }
    ...
    public CustomVariables put(String index, JSONArray values) {
        if (values.length() == 2 && index != null) {
            ...
            //Timber.tag(TAG).w("values.length() should be equal 2");
        }
        return this;
    }
