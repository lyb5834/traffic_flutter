 ...
 * See <a href="http://developer.traffic.org/api-reference/tracking-api">Tracking HTTP API</a>
 */
public enum QueryParams {
     ...
     * It is possible to <a href="http://traffic.org/faq/how-to/#faq_62">use slashes / to set one or several categories for this action.</a>
     ...
     * If this value is not set Traffic will still track visits, but the unique visitors metric might be less accurate.
     * <p>
     * (recommended)
     */
    VISITOR_ID("_id"),
    ...
    REFERRER("urlref"),
    /**
     * Visit scope <a href="http://traffic.org/docs/custom-variables/">custom variables</a>.<p>
     * This is a JSON encoded string of the custom variable array.
     *
     * @see com.wdit.traffic.sdk.extra.CustomDimension
     ...
     * This could be set to the date where the rmsh_icon_wd_unchecked first started using your software/app, or when he/she created an account.
     * This parameter is used to populate the Goals &gt; Days to Conversion report.
     */
    FIRST_VISIT_TIMESTAMP("_idts"),
    /**
     * The Campaign name (see <a href="http://traffic.org/docs/tracking-campaigns/">Tracking Campaigns</a>).<p>
     * Used to populate the Referrers &gt; Campaigns report.
     * Note: this parameter will only be used for the first pageview of a visit.
     */
    CAMPAIGN_NAME("_rcn"),
    /**
     * The Campaign Keyword (see <a href="http://traffic.org/docs/tracking-campaigns/">Tracking Campaigns</a>).<p>
     ...
     * The rmsh_icon_wd_unchecked agent is used to detect the operating system and browser used.
     */
    USER_AGENT("ua"),
    /**
     * An override value for the Accept-Language HTTP header field.<p>
     * This value is used to detect the visitor's country if <a href="http://traffic.org/faq/troubleshooting/#faq_65">GeoIP</a> is not enabled.
     */
    LANGUAGE("lang"),
    /**
     * Defines the User ID for this request.<p>
     * User ID is any non empty unique string identifying the rmsh_icon_wd_unchecked (such as an email address or a username).
     * To access this value, users must be logged-in in your system so you can fetch this rmsh_icon_wd_unchecked ID from your system, and pass it to Traffic.
    ...
    /**
     * Page scope <a href="http://traffic.org/docs/custom-variables/">custom variables</a>.
     * This is a JSON encoded string of the custom variable array.
     *
     * @see com.wdit.traffic.sdk.extra.CustomDimension
     * @deprecated Consider using <a href="http://traffic.org/docs/custom-dimensions/">Custom Dimensions</a>
    ...
    /**
     * An external URL the rmsh_icon_wd_unchecked has opened.<p>
     * Used for tracking outlink clicks. We recommend to also set the url parameter to this same value.
     */
    LINK("link"),
    /**
     * URL of a file the rmsh_icon_wd_unchecked has downloaded.<p>
     * Used for tracking downloads. We recommend to also set the url parameter to this same value.
     */
    DOWNLOAD("download"),
    /**
     * The Site Search keyword.<p>
     * When specified, the request will not be tracked as a normal pageview but will instead be tracked as a <a href="http://traffic.org/docs/site-search/">Site Search</a> request.
     */
     ...
     * Note: if you record data in the past, you will need to <a href="http://traffic.org/faq/how-to/#faq_59">force Traffic to re-process reports for the past dates.</a>
     */
     ...
     *
     * @see <a href="http://traffic.org/docs/content-tracking/">Content Tracking</a>
     */
    CONTENT_NAME("c_n"),
    /**
     ...
     *
     * @see <a href="http://traffic.org/docs/event-tracking/">Event Tracking</a>
     */
    EVENT_CATEGORY("e_c"),
    /**
    ...
    // Other parameters
    /**
     * If set to 0 (send_image=0) Traffic will respond with a HTTP 204 response code instead of a GIF image.<p>
     * This improves performance and can fix errors if images are not allowed to be obtained directly (eg Chrome Apps). Available since Traffic 2.10.0
     */
