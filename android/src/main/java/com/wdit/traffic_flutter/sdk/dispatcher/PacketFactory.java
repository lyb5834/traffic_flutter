...
public class PacketFactory {
    private static final String TAG = Traffic.tag(PacketFactory.class);
    @VisibleForTesting
    ...
    // "http://domain.com/traffic.php?idsite=1&url=http://a.org&action_name=Test bulk log Pageview&rec=1"
    @Nullable
