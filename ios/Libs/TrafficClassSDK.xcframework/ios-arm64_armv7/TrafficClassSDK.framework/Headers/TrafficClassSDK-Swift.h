...
#ifndef TRAFFICCLASSSDK_SWIFT_H
#define TRAFFICCLASSSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TrafficClassSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP15TrafficClassSDK6Logger_")
@protocol Logger
...
SWIFT_CLASS("_TtC15TrafficClassSDK13DefaultLogger")
...
SWIFT_CLASS("_TtC15TrafficClassSDK6Device")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC15TrafficClassSDK13MatomoTracker")
@interface MatomoTracker : NSObject
...
/// Per default it is a <code>DefaultLogger</code> with a <code>minLevel</code> of <code>LogLevel.warning</code>. You can
/// set your own Logger with a custom <code>minLevel</code> or a complete custom logging mechanism.
...
///
/// \param baseURL The url of the Matomo server. This url has to end in <code>piwik.php</code> or <code>matomo.php</code>.
///
...
/// More information on campaigns: <a href="https://matomo.org/docs/tracking-campaigns/">https://matomo.org/docs/tracking-campaigns/</a>
...
/// More information on content: <a href="https://matomo.org/docs/content-tracking/">https://matomo.org/docs/content-tracking/</a>
...
@interface MatomoTracker (SWIFT_EXTENSION(TrafficClassSDK))
...
- (void)trackWithEventWithCategory:(NSString * _Nonnull)category action:(NSString * _Nonnull)action name:(NSString * _Nullable)name number:(NSNumber * _Nullable)number SWIFT_DEPRECATED_MSG("use track(eventWithCategory:action:name:number:url instead");
...
SWIFT_CLASS("_TtC15TrafficClassSDK18MatomoTrackerClass")
@interface MatomoTrackerClass : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC15TrafficClassSDK11MemoryQueue")
...
SWIFT_CLASS("_TtC15TrafficClassSDK11TrackerTool")
@interface TrackerTool : NSObject
+ (void)setSitId:(NSString * _Nonnull)siteId;
+ (void)setUserId:(NSString * _Nonnull)userId;
/// MARK: 页面列表事件
+ (void)addTrackView:(NSArray<NSString *> * _Nonnull)views variables:(NSArray<Variable *> * _Nonnull)variables;
+ (void)addTrackView:(NSArray<NSString *> * _Nonnull)views variables:(NSArray<Variable *> * _Nonnull)variables url:(NSURL * _Nullable)url;
/// MARK: 按钮点击事件
+ (void)trackerEventCategory:(NSString * _Nonnull)category action:(NSString * _Nonnull)action variables:(NSArray<Variable *> * _Nonnull)variables;
+ (void)trackerEventCategory:(NSString * _Nonnull)category action:(NSString * _Nonnull)action variables:(NSArray<Variable *> * _Nonnull)variables url:(NSURL * _Nullable)url;
+ (void)trackerEventCategory:(NSString * _Nonnull)category action:(NSString * _Nonnull)action variables:(NSArray<Variable *> * _Nonnull)variables name:(NSString * _Nullable)name number:(NSNumber * _Nullable)number url:(NSURL * _Nullable)url;
/// MARK: 搜索结果
+ (void)trackSearchWithQuery:(NSString * _Nonnull)query category:(NSString * _Nullable)category resultCount:(NSInteger)resultCount variables:(NSArray<Variable *> * _Nonnull)variables url:(NSURL * _Nullable)url;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15TrafficClassSDK8Variable")
@interface Variable : NSObject
@property (nonatomic, readonly) NSUInteger index;
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly, copy) NSString * _Nonnull value;
- (nonnull instancetype)initWithIndex:(NSUInteger)index name:(NSString * _Nonnull)name value:(NSString * _Nonnull)value OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
